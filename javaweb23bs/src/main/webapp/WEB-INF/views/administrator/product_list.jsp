                    ...
                    <form class="form-inline" action="${base }/admin/product/list" method="get">
						...
						<div class="d-flex flex-row justify-content-between mt-4">
							<div class="d-flex flex-row">
								<input id="page" name="page" class="form-control" value="${productSearch.page }">
								
								<!-- tìm kiếm theo tên sản phẩm -->
								<input type="text" id="keyword" name="keyword" class="form-control" placeholder="Search" value="${productSearch.keyword }" autocomplete="off" style="margin-right: 5px;">
